...
class RestaurantStatusVController: UIViewController {
    ...
    func conditionShape() {
        ...
        breakfastCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
        
        lunchCondition.layer.cornerRadius = 10.0
        lunchCondition.layer.borderWidth = 2.0
        lunchCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
        
        dinnerCondition.layer.cornerRadius = 10.0
        dinnerCondition.layer.borderWidth = 2.0
        dinnerCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
        
        cheapCondition.layer.cornerRadius = 10.0
        cheapCondition.layer.borderWidth = 2.0
        cheapCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
        
        normalPriceCondition.layer.cornerRadius = 10.0
        normalPriceCondition.layer.borderWidth = 2.0
        normalPriceCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
        
        expensiveCondition.layer.cornerRadius = 10.0
        expensiveCondition.layer.borderWidth = 2.0
        expensiveCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
        
        vegetarianCondition.layer.cornerRadius = 10.0
        vegetarianCondition.layer.borderWidth = 2.0
        vegetarianCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
        
        spicyCondition.layer.cornerRadius = 10.0
        spicyCondition.layer.borderWidth = 2.0
        spicyCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
        
        noRiceCondition.layer.cornerRadius = 10.0
        noRiceCondition.layer.borderWidth = 2.0
        noRiceCondition.layer.borderColor = UIColor(red: 148/255, green: 151/255, blue: 153/255, alpha: 1).cgColor
    }
    ...
    override func viewDidLoad() {
        ...
        if showData().breakfastList.contains(introductionName.text!) {
            breakfastCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
        
        if showData().lunchList.contains(introductionName.text!) {
            lunchCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
        
        if showData().dinnerList.contains(introductionName.text!) {
            dinnerCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
        
        if showData().cheapList.contains(introductionName.text!) {
            cheapCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
        
        if showData().normalPriceList.contains(introductionName.text!) {
            normalPriceCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
        
        if showData().expensiveList.contains(introductionName.text!) {
            expensiveCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
        
        if showData().vegetarianList.contains(introductionName.text!) {
            vegetarianCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
        
        if showData().spicyList.contains(introductionName.text!) {
            spicyCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
        
        if showData().noRiceList.contains(introductionName.text!) {
            noRiceCondition.layer.backgroundColor = UIColor(red: 222/255, green: 243/255, blue: 252/255, alpha: 1).cgColor
        }
    }
